...
const fetchMovies = async () => {
  ...
  const response = await fetch("https://api.themoviedb.org/3/movie/now_playing?language=en-US&page=1", options); //change
...
const MovieList: React.FC = async () => {
  ...
  return (
    ...
    <div className="flex-grow bg-gray-900 p-10">
      ...
      <h2 className="text-3xl font-bold mb-6 text-center text-white">Recently Added Movies</h2>
