...
const fetchTVShows = async (): Promise<TVShow[]> => {
  ...
  const response = await fetch('https://react-movies-backend-knbt.onrender.com/api/tv/airing_today');
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex justify-center mb-6">
          <a href="/tv/popular" className="text-white px-4 py-2 border border-gray-500 rounded-md mx-2 bg-gray-800 hover:bg-gray-600 transition duration-300">Most Watched</a>
          ...
          <a href="/tv/recent" className="text-white px-4 py-2 border border-blue-500 rounded-md mx-2 bg-blue-500 hover:bg-blue-700 transition duration-300">Recently Added</a>
        </div>
        <h2 className="text-3xl font-bold mb-6 text-center text-white">On The Air</h2>
