...
const fetchTVShows = async (): Promise<TVShow[]> => {
  ...
  // console.log("Upcoming TV: ", JSON.stringify(data.results));
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex justify-center mb-6">
          ...
          <a href="/tv/upcoming" className="text-white px-4 py-2 border border-blue-500 rounded-md mx-2 bg-blue-500 hover:bg-blue-700 transition duration-300">Release Date</a>
        ...
        <h2 className="text-3xl font-bold mb-6 text-center text-white">Airing Today</h2>
