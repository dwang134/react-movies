...
<div className="contentSection w-full py-10">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8">Trending Now</h2>
                <Swiper
                    slidesPerView={1}
                    spaceBetween={10}
                ...
                >
                    {allTrendingStuff.results.slice(0, 20).map((item: any) => (
                        <SwiperSlide key={item.id}>
                            <div className="trendingItemCard bg-white p-4 rounded-lg shadow-md">
                                ...
                                <p className="text-gray-600 line-clamp-3">{item.overview}</p>
                                {item.media_type !== 'person' && (
